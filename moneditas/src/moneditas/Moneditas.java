...
public class Moneditas {
    public static void main(String[] args) {
        ...
        for (moneda = 1; moneda <= 5; moneda++) {
            System.out.print("Digite en cual fila desea poner la moneda " + moneda + ": ");
            monedax = leer.nextInt();
            System.out.print("Digite en cual columna desea poner la moneda " + moneda + ": ");
                    ...
                    if (personajey + 1 > 9) {
                        ...
                        if (tablero[personajex][personajey + 1] == 2) {
                            ...
                            if (moneditas == 5) {
                                ...
                                System.out.print("\nPerdió - Le faltaron " + (5 - moneditas) + " Moneditas\n");
                                opcion = 5;
                            }
                            ...
                            if (vida <= 0) {
                                ...
                                System.out.print("\nTe has comido una mina - Vida restante: " + vida + "\n");
                                opcion = 5;
                            }
                            ...
                            System.out.print("\nRecogiste gasolina - Vida actual: " + vida + "\n");
                        } else {
                            tablero[personajex][personajey + 1] = 1;
                            tablero[personajex][personajey] = 0;
                            personajey++;
                    ...
                    if (personajey - 1 < 0) {
                        ...
                        if (tablero[personajex][personajey - 1] == 2) {
                            ...
                            if (vida <= 0) {
                                ...
                                System.out.print("\nChocó con una mina - Vida restante: " + vida + "\n");
                                opcion = 5;
                            }
                        } else if (tablero[personajex][personajey - 1] == 5) {
                            tablero[personajex][personajey - 1] = 1;
                            ...
                            System.out.print("\nRecogió gasolina - Vida actual: " + vida + "\n");
                        } else {
                            tablero[personajex][personajey - 1] = 1;
                            tablero[personajex][personajey] = 0;
                            personajey--;
                ...
                case 4:
                    ...
                    if (personajex + 1 > 9) {
                        ...
                        if (tablero[personajex + 1][personajey] == 2) {
                            ...
                            tablero[personajex][personajey] = 0;
                            if (moneditas == 5) {
                                System.out.print("\n HAS GANADO! - Monedas: " + moneditas + "\n");
                                opcion = 5;
                            } else {
                                System.out.print("\nPERDISTE:( - Le faltaron " + (5 - moneditas) + " Moneditas\n");
                                opcion = 5;
                            }
                        } else if (tablero[personajex + 1][personajey] == 4) {
                            tablero[personajex][personajey] = 0;
